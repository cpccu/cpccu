...
export default function NavBar() {
  ...
  return (
    <nav className="px-8 md:mt-8 sticky top-0 z-50 h-28 w-full bg-header flex flex-row-reverse md:flex-row items-center justify-between py-3 text-white shadow-md shadow-black/90">
