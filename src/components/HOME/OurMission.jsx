...
export default function OurMission() {
  ...
  return (
    <section
      id="ourMission"
      class="relative flex items-center justify-end px-[0.2em] lg:px-[2.9em] xl:px-[7em] pb-12 lg:py-[23rem]"
    >
      <main
      ...
      >
        ...
        <section class="flex flex-col gap-4">
          ...
          <p class="text-gray-800">{Data?.context3}</p>
          <p class="text-gray-800">{Data?.context4}</p>
          <p class="text-gray-800">{Data?.context5}</p>
          <p class="text-gray-800">{Data?.context6}</p>
        </section>
        <button
          onClick={goToAbout}
