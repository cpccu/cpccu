    ...
    <ul className="flex flex-col lg:flex-row z-50 mt-10 lg:mt-0">
      ...
      <li>
        <NavLink to={`/login`} className={({ isActive }) =>
          ` ${isActive
            ? "bg-header text-white lg:border-b-4 lg:border-header lg:text-black lg:bg-header/20 lg:hover:bg-header/20"
            : "bg-header/90 hover:bg-header text-white hover:text-header trans hover:bg-header/20 lg:hover:bg-transparent md:hidden"
          } block px-5 md:px-7 py-2 lg:py-7 cursor-pointer font-semibold capitalize`
        }
          onClick={() => setOpen(false)}
        >Log In</NavLink>
      ...
      <li>
        <NavLink to={`/signup`} className={({ isActive }) =>
          ` ${isActive
            ? "bg-header text-white  lg:border-b-4 lg:border-header lg:text-black lg:bg-header/20 lg:hover:bg-header/20"
            : "bg-green-600 hover:bg-green-500 text-white hover:text-header  trans hover:bg-header/20 lg:hover:bg-transparent md:hidden"
          } block px-5 md:px-7 py-2 lg:py-7 cursor-pointer font-semibold capitalize`
        }
          onClick={() => setOpen(false)}
        >Sign Up</NavLink>
